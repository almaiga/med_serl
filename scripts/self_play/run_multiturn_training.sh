...
INJECTOR_MAX_NEW_TOKENS="${INJECTOR_MAX_NEW_TOKENS:-1024}"  # v6-proven; see agent_loop_config.yaml (the value that actually reaches the agent)
ASSESSOR_MAX_NEW_TOKENS="${ASSESSOR_MAX_NEW_TOKENS:-2048}"
ASSESSOR_THINK_MAX_NEW_TOKENS="${ASSESSOR_THINK_MAX_NEW_TOKENS:-$ASSESSOR_MAX_NEW_TOKENS}"
ASSESSOR_FINAL_MAX_NEW_TOKENS="${ASSESSOR_FINAL_MAX_NEW_TOKENS:-256}"
